    ...
    else
    {
        ...
        if( bExclusive )
        {
            strcat( strExcepted, "Exclusive mode prevents other applications from "
                                 ...
                                 "Windows itself requires exclusive access to the "
                                 "mouse because mouse events such as a click on "
                                 "an inactive window could force an application "
                                 "to unacquire the device, with potentially harmful "
                                 "results, such as a loss of data from the input "
                                 "buffer. Therefore, when an application has "
                                 "exclusive access to the mouse, Windows is not "
                                 "allowed any access at all. No mouse messages are "
                                 "generated. A further side effect is that the "
                                 "cursor disappears. When accessing the menu, the sample "
                                 "releases the mouse so the mouse is displayed again.\n\n" );
        }
        else
        {
        ...
        strcat( strExcepted, "The sample will read the mouse 12 times a second. "
                             "Typically an application would poll the mouse "
