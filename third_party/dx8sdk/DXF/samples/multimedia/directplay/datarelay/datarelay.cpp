...
VOID FillTargetCombo( HWND hDlg )
{
    ...
    // Add "none"
    nIndex = (int)SendMessage( hInfoTargetCombo, CB_ADDSTRING, 0, (LPARAM) "None" );
                           ...
                           DWORD dwLowMessages, DWORD dwLowBytes )
{
    ...
    if( pConnectionInfo )
    {
        ...
        _stprintf(strText, 
                           "Send Queue Messages High Priority=%d\r\n"       \
                           "Send Queue Bytes High Priority=%d\r\n"     \
                           
                           "Send Queue Messages Normal Priority=%d\r\n"       \
                           "Send Queue Bytes Normal Priority=%d\r\n"     \

                           "Send Queue Messages Low Priority=%d\r\n"       \
                           "Send Queue Bytes Low Priority=%d\r\n"     \

                           "Round Trip Latency MS=%dms\r\n"                  \
                           "Throughput BPS=%d\r\n"                         \
                           "Peak Throughput BPS=%d\r\n"                     \
                                                                            \
                           "Bytes Sent Guaranteed=%d\r\n"                   \
                           "Packets Sent Guaranteed=%d\r\n"                 \
                           "Bytes Sent Non-Guaranteed=%d\r\n"                \
                           "Packets Sent Non-Guaranteed=%d\r\n"              \
                                                                            \
                           "Bytes Retried Guaranteed=%d\r\n"        \
                           "Packets Retried Guaranteed=%d\r\n"      \
                           "Bytes Dropped Non-Guaranteed=%d\r\n"    \
                           "Packets Dropped Non-Guaranteed=%d\r\n"  \
                                                                            \
                           "Messages Transmitted High Priority=%d\r\n"       \
                           "Messages Timed Out High Priority=%d\r\n"          \
                           "Messages Transmitted Normal Priority=%d\r\n"     \
                           "Messages Timed Out Normal Priority=%d\r\n"        \
                           "Messages Transmitted Low Priority=%d\r\n"        \
                           "Messages Timed Out Low Priority=%d\r\n"           \
                                                                            \
                           "Bytes Received Guaranteed=%d\r\n"               \
