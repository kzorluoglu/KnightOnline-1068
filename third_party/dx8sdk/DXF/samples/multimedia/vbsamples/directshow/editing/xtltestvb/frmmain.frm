...
' *
            ...
            If ObjPtr(m_objRenderEngine) > 0 Then Set m_objRenderEngine = Nothing
            Exit Sub
...
ErrLine:
            ...
            If ObjPtr(m_objRenderEngine) = 0 Then Exit Sub
            ...
            If ObjPtr(objFilterGraphManager) > 0 Then
               Call objFilterGraphManager.Stop
               Set objMediaPosition = objFilterGraphManager
               If ObjPtr(objMediaPosition) > 0 Then objMediaPosition.CurrentPosition = 0
...
ErrLine:
            ...
            'clean-up & dereference
            If ObjPtr(objXMLParser) > 0 Then Set objXMLParser = Nothing
            Exit Sub
            ...
            If ObjPtr(m_objMediaEvent) > 0 Then
               ...
               If objVideoWindow.Visible = False Then
                   'the user closed the video window, hault playback
                    If ObjPtr(m_objRenderEngine) > 0 Then
                       Call m_objRenderEngine.GetFilterGraph(objFilterGraphManager)
                    End If
