...
Private Sub tmrSendData_Timer()
    ...
    If mfSending Then 'We are sending
        If (timeGetTime - mlLastSendTime) > mlRate Then 'We should send another packet now
            mfInSend = True
            lMsg = MSG_GamePacket
...
Private Sub UpdateStats()
    ...
    If nSecondsPassed > 500 Then
        ...
        lblSendRate.Caption = Format$(CStr(nDataOut), "0.#")
        lblReceive.Caption = Format$(CStr(nDataIn), "0.#")
    End If
