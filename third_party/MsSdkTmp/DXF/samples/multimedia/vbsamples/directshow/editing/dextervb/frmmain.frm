...
Begin VB.Form frmMain 
   ...
   Begin ComCtl3.CoolBar ctrlCoolBar 
      ...
      Begin MSComctlLib.Toolbar tbMain 
         ...
         DisabledImageList=   "ctrlImageList"
         HotImageList    =   "ctrlImageList"
         _Version        =   393216
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Button3 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               ...
               Object.ToolTipText     =   "Export The Timeline"
               ImageIndex      =   3
            EndProperty
   ...
   Begin MSComctlLib.ImageList ctrlImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage19 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":38C2
            Key             =   ""
         EndProperty
         BeginProperty ListImage20 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":3BB6
            Key             =   ""
         EndProperty
         BeginProperty ListImage21 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":3EAA
            Key             =   ""
         EndProperty
         ...
         BeginProperty ListImage23 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":4492
            Key             =   ""
         EndProperty
         BeginProperty ListImage24 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":4786
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComDlg.CommonDialog dlgCommonDialog 
      ...
      _Version        =   393216
   End
   Begin MSComctlLib.ImageList ctrlImageList2 
      Left            =   8625
      Top             =   1050
      _ExtentX        =   1005
      _ExtentY        =   1005
...
Private m_boolDrag As Boolean                    'returns true if the user is moving the ide septum
...
ErrLine:
            ...
            If tvwSimpleTree.Nodes.Count > 0 Then
               If ObjPtr(tvwSimpleTree.SelectedItem) = 0 Then _
...
ErrLine:
            ...
            If ControlAvailable("lstViewInfo") Then
              'set the listview to report view
               lstViewInfo.View = lvwReport
               lstViewInfo.ColumnHeaders.Add , "Parameter", "Parameter", (lstViewInfo.Width / 2) - 50
               ...
               'ensure the listview has zero items
                If lstViewInfo.ListItems.Count <> 0 Then
                   lstViewInfo.ListItems.Clear
                End If
            End If
            
            If ControlAvailable("sbStatus") Then
            ...
            For nCount = 1 To Data.Files.Count
                  ...
                  If Len(bstrFileName) > 4 Then
                        ...
                        If InStr(1, LCase(bstrFileName), ".xtl") > 0 Then
                           ...
                           'verify restoration
                           If ObjPtr(objLocalTimeline) > 0 Then
                              'import succeeded; clean-up global scope
                              If ObjPtr(gbl_objTimeline) > 0 Then
...
ErrLine:
            ...
            If ControlAvailable("ctrlCoolBar") = True And ControlAvailable("sbStatus") = True Then
               'BOTH THE COOLBAR & STATUSBAR CONTROLS ARE AVAILABLE, PROCEED TO RESIZE
            ...
            If ControlAvailable("tvwSimpleTree") = True And ControlAvailable("lstViewInfo") = True Then
               'THE TREEVIEW & LISTVIEW ARE ADDITIONALLY AVAILABLE, PROCEED TO RESIZE
...
ErrLine:
            ...
            If ObjPtr(gbl_objQuartzVB) > 0 Then Set gbl_objQuartzVB = Nothing
            If ObjPtr(gbl_colNormalEnum) > 0 Then Set gbl_colNormalEnum = Nothing
            
            'dereference & clean-up application-level data
            If ObjPtr(gbl_objTimeline) > 0 Then Set gbl_objTimeline = Nothing
            If ObjPtr(gbl_objFilterGraph) > 0 Then Set gbl_objFilterGraph = Nothing
            If ObjPtr(gbl_objDexterObject) > 0 Then Set gbl_objDexterObject = Nothing
            If ObjPtr(gbl_objRenderEngine) > 0 Then Set gbl_objRenderEngine = Nothing
            Exit Sub
...
' *
            ...
            'set menu state
            If ObjPtr(tvwSimpleTree.SelectedItem) > 0 Then
...
ErrLine:
            ...
            If ObjPtr(gbl_objDexterObject) > 0 Then
            ...
            'clean-up & dereference
            If ObjPtr(objSource) > 0 Then Set objSource = Nothing
            Exit Sub
...
ErrLine:
            ...
            If ObjPtr(objSourceClip) > 0 Then
               With objSourceClip
                  'get media name
...
ErrLine:
            ...
            If ObjPtr(gbl_objTimeline) > 0 Then
               ...
               If ObjPtr(objNewComposite) > 0 Then Call InsertComposite(objNewComposite, gbl_objDexterObject)
               If ObjPtr(gbl_objDexterObject) > 0 Then Call gbl_objDexterObject.SetStartStop2(dblStartTime, dblStopTime)
               'refresh the ide
               Call GetTimelineDirect(tvwSimpleTree, gbl_objTimeline, gbl_colNormalEnum)
            End If
...
ErrLine:
            ...
            If ObjPtr(gbl_objTimeline) > 0 Then
               ...
               If ObjPtr(objNewEffect) > 0 Then Call InsertEffect(objNewEffect, gbl_objDexterObject, EffectFriendlyNameToCLSID(bstrEffectGUID), dblEffectStartTime, dblEffectStopTime)
               'refresh the ide
               Call GetTimelineDirect(tvwSimpleTree, gbl_objTimeline, gbl_colNormalEnum)
            End If
...
ErrLine:
            ...
            If ObjPtr(gbl_objTimeline) > 0 Then
               ...
               If ObjPtr(objNewTrack) > 0 Then Call InsertTrack(objNewTrack, gbl_objDexterObject, nPriority)
               'refresh the ide
               Call GetTimelineDirect(tvwSimpleTree, gbl_objTimeline, gbl_colNormalEnum)
            End If
...
ErrLine:
            ...
            If ObjPtr(gbl_objTimeline) > 0 Then
               ...
               If ObjPtr(objNewTransition) > 0 Then Call InsertTransition(objNewTransition, gbl_objDexterObject, TransitionFriendlyNameToCLSID(bstrTransition), dblStartTime, dblStopTime)
               'refresh the ide
               Call GetTimelineDirect(tvwSimpleTree, gbl_objTimeline, gbl_colNormalEnum)
            End If
...
ErrLine:
            ...
            'clean-up & dereference
            If ObjPtr(objComposition) > 0 Then Set objComposition = Nothing
            Exit Sub
...
ErrLine:
            ...
            'clean-up & dereference
            If ObjPtr(objEffect) > 0 Then Set objEffect = Nothing
            Exit Sub
...
ErrLine:
            ...
            If ObjPtr(gbl_objQuartzVB) > 0 Then
...
ErrLine:
            ...
            ' ******************************************************************************************************************************
            ' * procedure name: mnuFileNew_Click
            ...
            If ObjPtr(gbl_objTimeline) > 0 Then Call ClearTimeline(gbl_objTimeline)
            'dereference & clean-up application-level data
            If ObjPtr(gbl_objTimeline) > 0 Then Set gbl_objTimeline = Nothing
            If ObjPtr(gbl_objFilterGraph) > 0 Then Set gbl_objFilterGraph = Nothing
...
ErrLine:
            ...
            'display a common dialog for the user and obtain a filename
            bstrFileName = ShowCommonDlgOpen(vbNullString, "XTL", "XTL Files (*.xtl)|*.xtl|")
               ...
               If ObjPtr(objLocalTimeline) > 0 Then
                  ...
                  If ObjPtr(gbl_objTimeline) > 0 Then
                    'dereference & clean-up timeline
                     ...
                     If ObjPtr(gbl_objQuartzVB) > 0 Then Call gbl_objQuartzVB.StopGraph
                     If ObjPtr(gbl_objFilterGraph) > 0 Then Set gbl_objFilterGraph = Nothing
                     If ObjPtr(gbl_objRenderEngine) > 0 Then Call gbl_objRenderEngine.ScrapIt
                     If ObjPtr(gbl_objRenderEngine) > 0 Then Set gbl_objRenderEngine = Nothing
                  End If
                  'assign the local timeline to global scope
                  Set gbl_objTimeline = objLocalTimeline
                  ...
                  'reset module-level filename
                  gbl_bstrLoadFile = dlgCommonDialog.FileName
                  'reset the caption on the application's main form
                  bstrFileName = Mid(bstrFileName, InStrRev(bstrFileName, "\") + 1)
                  Me.Caption = "DexterVB - " & bstrFileName
               End If
            End If
            'clean-up & dereference
            If ObjPtr(objLocalTimeline) > 0 Then Set objLocalTimeline = Nothing
            Exit Sub
...
ErrLine:
            ...
            'display a common dialog for the user and obtain a filename
            bstrFileName = ShowCommonDlgSave(vbNullString, "XTL", "XTL Files (*.xtl)|*.xtl|Graph Files (*.grf)|*.grf|")
...
ErrLine:
            ...
            If ObjPtr(objNewGroup) > 0 Then Call InsertGroup(gbl_objTimeline, objNewGroup)
...
ErrLine:
            ...
            If ObjPtr(gbl_objTimeline) > 0 Then
               ...
               If ObjPtr(objNewSourceClip) > 0 Then Call InsertSource(gbl_objDexterObject, objNewSourceClip, bstrMediaSourceName, dblTStart, dblTStop, dblMStart, dblMStop)
               If ObjPtr(objNewSourceClip) > 0 Then
                  'refresh the ide
                  Call GetTimelineDirect(tvwSimpleTree, gbl_objTimeline, gbl_colNormalEnum)
                  'update the button(s)
                  With tbMain.Buttons
...
ErrLine:
            ...
            'clean-up & dereference
            If ObjPtr(objTrack) > 0 Then Set objTrack = Nothing
            Exit Sub
...
ErrLine:
            ...
            'clean-up & dereference
            If ObjPtr(objTransition) > 0 Then Set objTransition = Nothing
            Exit Sub
...
ErrLine:
            ...
            If ObjPtr(objTransition) > 0 Then
               With objTransition
                  'get cutpoint
...
ErrLine:
            ...
            If ObjPtr(lstViewInfo.HitTest(X, Y)) = 0 Then lstViewInfo.ToolTipText = vbNullString
            Exit Sub
...
ErrLine:
            ...
            If ObjPtr(tvwSimpleTree.SelectedItem) = 0 Then
               If tvwSimpleTree.Nodes.Count > 0 Then
                  If ObjPtr(tvwSimpleTree.Nodes(1).Root) > 0 Then
...
ErrLine:
            ...
            'ensure selected
            If ObjPtr(node) > 0 Then Set tvwSimpleTree.SelectedItem = node
            Exit Sub
...
ErrLine:
            ...
            If ObjPtr(gbl_colNormalEnum(objNode.Key)) > 0 Then
...
ErrLine:
            ...
            If ObjPtr(tvwSimpleTree.HitTest(X, Y)) > 0 Then
               Set objNode = tvwSimpleTree.HitTest(X, Y)
               Set tvwSimpleTree.SelectedItem = objNode
            ElseIf ObjPtr(tvwSimpleTree.SelectedItem) > 0 Then
               Set objNode = tvwSimpleTree.SelectedItem
            Else: Exit Sub
            End If
            ...
            'clean-up & dereference
            If ObjPtr(objNode) > 0 Then Set objNode = Nothing
            Exit Sub
...
ErrLine:
            ...
            'disable tooltip if a hittest on the current position fails
            If ObjPtr(tvwSimpleTree.HitTest(X, Y)) = 0 Then tvwSimpleTree.ToolTipText = vbNullString
            Exit Sub
...
ErrLine:
            ...
            'update the listview with the item's information
            If ObjPtr(gbl_colNormalEnum(node.Key)) > 0 Then
            ...
            On Local Error GoTo ErrLine
                 ...
                 Select Case LCase(Button.Key)
                     ...
                     Case "play"
                               ...
                               'wait until the media has completed
                               Do Until gbl_objQuartzVB.Position = gbl_objQuartzVB.StopTime: DoEvents
                                  'be sure to stop the media if the app is closing
                     ...
                     Case "pause"
                              ...
                              'update the button(s)
                               With tbMain.Buttons
                                  ...
                                  .Item("Stop").Image = 8
                                  .Item("Rewind").Image = 4
                                  .Item("FastForward").Image = 10
                                  .Item("SeekForward").Image = 9
                                  .Item("SeekBackward").Image = 5
                                  .Item("Play").Enabled = True
                                  .Item("Pause").Enabled = False
                                  .Item("Stop").Enabled = True
...
' *
            ' ******************************************************************************************************************************
            ' * procedure name: ControlAvailable
            ' * procedure description:  returns true if the specified control exists within the context of this form
            ' *
            ' ******************************************************************************************************************************
            Private Function ControlAvailable(Index As Variant) As Boolean
            Dim ctrl As Control
            On Local Error GoTo ErrLine
            
            If ObjPtr(Me.Controls(Index)) > 0 Then
