...
ErrLine:
            ...
            If ObjPtr(pin) > 0 Then Set pin = Nothing
            If ObjPtr(pfilter) > 0 Then Set pfilter = Nothing
            If ObjPtr(pinOther) > 0 Then Set pinOther = Nothing
            Exit Sub
...
ErrLine:
            ...
            'clean-up & dereference local data
            If ObjPtr(pin) > 0 Then Set pin = Nothing
            If ObjPtr(filter) > 0 Then Set filter = Nothing
            If ObjPtr(pinOther) > 0 Then Set pinOther = Nothing
            Exit Sub
