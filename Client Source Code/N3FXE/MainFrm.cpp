		...
		case FX_PART_TYPE_MESH:
			{
				...
				{
					MessageBox("n3fxpart������ ���µ� �����߽��ϴ�...-.-;;","ERR01",MB_OK);
...
void CMainFrame::OnFileLoadBundle() 
{
	...
	while(pos != NULL)
	{
		...
		{
			MessageBox("n3fxbundle������ ���µ� �����߽��ϴ�.","-.-;;",MB_OK);
...
//	m_Chr.RotSet(qt);
	...
	CN3Base::s_AlphaMgr.Render(); // �̰� �ݵ�� ����� ���ĺ����� ���� �����÷ο찡 �ȳ���..
...
void CMainFrame::OnFileLoadGroup() 
{
	...
	while(pos != NULL)
	{
		...
		{
			MessageBox("n3fxgroup������ ���µ� �����߽��ϴ�.","-.-;;",MB_OK);
			pEditWnd->DestroyWindow();
			delete pEditWnd;
		}
	}
