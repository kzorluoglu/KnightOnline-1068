...
void CUIItemExchange::UserPressOK()
{
	...
	CAPISocket::MP_AddShort(byBuff, iOffset, iCount);		// ���̵� ���� ��Ŷ�� �ֱ�..
	for( int i = 0; i < iCount; i++ )
	{
		CAPISocket::MP_AddByte(byBuff, iOffset, m_pMyNpcWndOriginIndex[i]);		// ���̵� ���� ��Ŷ�� �ֱ�..
		CAPISocket::MP_AddDword(byBuff, iOffset, m_pMyNpcWnd[i]->pItemBasic->dwID+m_pMyNpcWnd[i]->pItemExt->dwID);	// ���̵� ���ڿ� ��Ŷ�� �ֱ�..
	}
