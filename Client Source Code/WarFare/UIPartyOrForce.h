...
public:
	...
	void						MemberDestroy();
	int							MemberCount() { return (int)m_Members.size(); }
	void						MemberSelect(int iMemberIndex) { if(iMemberIndex < 0 || iMemberIndex >= (int)m_Members.size()) return; m_iIndexSelected = iMemberIndex; }
