...
void CRiverMng::SelectVtxByDragRect(RECT* pRect, BOOL bAdd)
{
	...
	int i;
	if (m_pSelRiver)	// �̹� ���õ� ���� �ִٸ�..
	{
		int iVC = m_pSelRiver->VertexCount();	// �װ��� �� ���ڸ� ���ϱ�
		for (i=0; i<iVC;++i)
		{
			__VertexXyzT2* pVtx = m_pSelRiver->GetVertex(i);	// �� �ϳ� ���ϱ�
			if (pVtx == NULL) continue;
...
void CRiverMng::DeleteSelectedVertex()									// ���õ� ���� �����
{
	if (m_pSelRiver == NULL) return;
