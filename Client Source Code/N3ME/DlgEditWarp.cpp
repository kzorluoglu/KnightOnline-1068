...
{
	CFileDialog dlg(FALSE, "wap", "Noname", OFN_EXPLORER | OFN_LONGNAMES | OFN_OVERWRITEPROMPT, "Warp Info����(*.wap)|*.wap||");
...
void CDlgEditWarp::OnBtnImport() 
{
	...
	CFileDialog dlg(TRUE, "wap", NULL, dwFlags, "Warp Info����(*.wap)|*.wap||", NULL);
