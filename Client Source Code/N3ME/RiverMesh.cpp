...
bool CRiverMesh::Load(HANDLE hFile)
{
	...
	ReadFile(hFile, &m_iRiverID, sizeof(m_iRiverID), &dwNum, NULL);		// �� ��ȣ
	ReadFile(hFile, &m_fSpeed1, sizeof(m_fSpeed1), &dwNum, NULL);			// ����
	ReadFile(hFile, &m_fSpeed2, sizeof(m_fSpeed2), &dwNum, NULL);			// ����2
	ReadFile(hFile, &m_fMeterPerV, sizeof(m_fMeterPerV), &dwNum, NULL);	// U��ǥ 1.0�� �ش��ϴ� ���� ����
	ReadFile(hFile, &m_fMeterPerU, sizeof(m_fMeterPerU), &dwNum, NULL);	// V��ǥ 1.0�� �ش��ϴ� ���� ����
	ReadFile(hFile, &m_fMeterPerV2, sizeof(m_fMeterPerV2), &dwNum, NULL);// U2��ǥ 1.0�� �ش��ϴ� ���� ����
	ReadFile(hFile, &m_fMeterPerU2, sizeof(m_fMeterPerU2), &dwNum, NULL);// V2��ǥ 1.0�� �ش��ϴ� ���� ����
	ReadFile(hFile, &m_dwAlphaFactor, sizeof(m_dwAlphaFactor), &dwNum, NULL);	// ���� �����ϰ� �ϱ� ���� ���İ�
	...
	{
		ReadFile(hFile, &iLen, sizeof(iLen), &dwNum, NULL);	// texture name length
		if (iLen <=0) { m_pAnimTextures[i] = NULL; __ASSERT(0, "�ؽ��İ� ����"); continue;}
		ReadFile(hFile, szTextueFName, iLen, &dwNum, NULL);	// texture name
		szTextueFName[iLen] = NULL;
...
bool CRiverMesh::Save(HANDLE hFile)
{
	...
	WriteFile(hFile, &m_iRiverID, sizeof(m_iRiverID), &dwNum, NULL);		// �� ��ȣ
	WriteFile(hFile, &m_fSpeed1, sizeof(m_fSpeed1), &dwNum, NULL);			// ����1
	WriteFile(hFile, &m_fSpeed2, sizeof(m_fSpeed2), &dwNum, NULL);			// ����2
	WriteFile(hFile, &m_fMeterPerV, sizeof(m_fMeterPerV), &dwNum, NULL);	// U��ǥ 1.0�� �ش��ϴ� ���� ����
	WriteFile(hFile, &m_fMeterPerU, sizeof(m_fMeterPerU), &dwNum, NULL);	// V��ǥ 1.0�� �ش��ϴ� ���� ����
	WriteFile(hFile, &m_fMeterPerV2, sizeof(m_fMeterPerV2), &dwNum, NULL);	// U2��ǥ 1.0�� �ش��ϴ� ���� ����
	WriteFile(hFile, &m_fMeterPerU2, sizeof(m_fMeterPerU2), &dwNum, NULL);	// V2��ǥ 1.0�� �ش��ϴ� ���� ����
	WriteFile(hFile, &m_dwAlphaFactor, sizeof(m_dwAlphaFactor), &dwNum, NULL);	// ���� �����ϰ� �ϱ� ���� ���İ�
	...
	for (i=0; i<m_iAnimTextureCount; ++i)
	{
		__ASSERT(m_pAnimTextures[i], "���� �ؽ��� �����Ͱ� NULL�Դϴ�.");
...
void CRiverMesh::Render()
{
	...
	if (m_pTexture && m_iVC>4)
	{
		...
		if ((m_dwAlphaFactor & 0xff000000) != 0xff000000)	// alpha factor �����ϱ�
		{
			// render state ����
			...
			s_lpD3DDev->SetRenderState(D3DRS_TEXTUREFACTOR, m_dwAlphaFactor);	// alpha factor ����
			// texture state ����(alpha)
...
void CRiverMesh::RenderVertexPoint()	// �ߺ��̰� ���� �ٽ� �׸���
{
...
BOOL CRiverMesh::SetAnimTextureName(LPCTSTR pszFName, LPCTSTR pszExt, int iCount)
{
	...
	__ASSERT(iCount<100, "���� ���ϸ��̼� �ؽ��İ� �ʹ� �����ϴ�.");
