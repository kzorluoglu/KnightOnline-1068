...
/*
	...
	{
		MessageBox("ȭ����� ��尡 32bit����̾�� �մϴ�..","���!!");
	}
*/	
	m_pMapMng->SetCursorMode(CM_SET_DTEX);
//	this->OnViewDtex(); // ȭ�鿡 Ÿ�� �ؽ�ó �׷� ���̾�α׸� �����ش�..
}
...
void CMainFrame::OnUpdateViewHideObj(CCmdUI* pCmdUI) 
{
	...
	if(m_pMapMng->m_bHideObj) pCmdUI->SetText("������Ʈ ���̱�\tH");
	if(!m_pMapMng->m_bHideObj) pCmdUI->SetText("������Ʈ ���߱�\tH");	
}
...
void CMainFrame::OnTipDefaultMaterial() // �⺻������ �����.
{
	ASSERT(m_pMapMng);
	...
	for(int i = 0; i < nSel; i++)
	{
		...
		if(pObj->Type() & OBJ_SHAPE)
		{
			...
			pShape->MakeDefaultMaterial(); // �⺻������ �����.
		}
	}
}

void CMainFrame::OnTipRemoveAlphaflag() // ���� ������ �÷��� ����..
{
	ASSERT(m_pMapMng);
	...
	for(int i = 0; i < nSel; i++)
	{
		...
		{
			CN3Shape* pShape = (CN3Shape*)pObj;
			pShape->RemoveRenderFlags(RF_ALPHABLENDING); // ���� ������ �÷��� ����..
		}
	}
}
