...
void CDlgRegenUser::OnBtnLoadPathset() 
{
	...
	CFileDialog dlg(TRUE, "trur", NULL, dwFlags, "trur����(*.trur)|*.trur||", NULL);
...
void CDlgRegenUser::OnBtnSavePathset() 
{
	...
	{
		CFileDialog dlg(FALSE, "trur", "Noname", OFN_EXPLORER | OFN_LONGNAMES | OFN_OVERWRITEPROMPT, "trur����(*.trur)|*.trur||");
