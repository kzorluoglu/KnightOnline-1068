...
//	tick...
//	����Ʈ���� ��ü...^^
//	�ϴ� ���ÿ����ȿ� ����� �˻�(IntersectRect()..)�� �ϰ�..
//	���ÿ����ȿ� ��� �׸������� �� ������ ������ �˻�..
//
void CQTNode::Tick()
{
	m_State = QTNODESTATE_CLIPPED;	//���� �ʱ�ȭ..

	//���ÿ����ȿ�������˻�.
	RECT rt;
	int Range = 1 << (m_pRefTerrain->m_iMaxLevel - m_Level);	// �߽������� �����ڸ����� �Ÿ�.
	SetRect(&rt, m_CenterX - Range, m_CenterZ - Range, m_CenterX + Range, m_CenterZ + Range);
	
	RECT rt1;
	if(IntersectRect(&rt1, &rt, &(m_pRefTerrain->m_VisibleRect))==0) return;	//���ÿ����ȿ� ���� ������ ����..
...
void CQTNode::RenderMaxLevel()
{
	...
	for(i=0;i<2;i++)
	{
		...
		if((m_pRefTerrain->m_ppMapData[cx][cz].DTexInfo1.Attr.Group<=0) || m_pRefTerrain->GetTileTex(tmpTIdx)==NULL)	//Ÿ���� ������...
		{
...
//
//	m_pRefTerrain->m_iMaxLevel�� �ƴ� Level�� Render..
//
