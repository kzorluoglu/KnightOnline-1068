...
void CDlgShapeList::UpdateTree(CN3Scene* pScene)
{
	...
	if (pScene && m_IsSourceObj)	// Source�� ����..
	{
		m_pSceneRef = pScene;
	...
	else if (!pScene && !m_IsSourceObj)				// Output�� ����..
	{
...
int	CDlgShapeList::GetTotalShapeInfoCount()									// Output��..
{
	if (m_IsSourceObj)
	{
		ASSERT(0);
...
CN3Shape* CDlgShapeList::GetShapeByiOrder(int iOrder)				// Output��..
{
	if (m_IsSourceObj)
	{
		ASSERT(0);
...
void CDlgShapeList::SelectObject(void* pItemData)	// Output�� ����..
{
