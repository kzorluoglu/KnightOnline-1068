...
public:
	...
	BOOL	m_IsSourceObj;		// Display���̳�? (������ ������Ʈ ���)
//	CMapMng* m_pMapMng;
...
// Dialog Data
	...
	void UpdateTree(CN3Scene* pScene = NULL);		 // Source��.. Output ����..
	void SelectObject(void* pItemData);							 // Output��..
	int	GetTotalShapeInfoCount();									// Output��..
	CN3Shape* GetShapeByiOrder(int iOrder);				// Output��..
