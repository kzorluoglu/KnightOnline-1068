...
{
	CString szExt = "";
//	CString szFilter = "N3D Object File|*.*|ī�޶� Data(*.N3Camera)|*.N3Camera|Light Data(*.N3Light)|*.N3Light|Shape Data(*.N3Shape)|*.N3Shape|\
// Progressive Mesh Data(*.N3PMesh)|*.N3Mesh|Indexed Mesh Data(*.N3IMesh)|*.N3IMesh|Joint Data(*.N3Joint)|*.N3Joint|Skinning Data(*.N3Skin)|*.N3Skin|Character Data(*.N3Chr)|*.N3Chr||";
	CString szFilter = "N3D Object File|*.*|ī�޶�(*.N3Camera)|*.N3Camera|Light(*.N3Light)|*.N3Light|Progressive Mesh(*.N3PMesh)|*.N3PMesh|Shape(*.N3Shape)|*.N3Shape|Character(*.N3Chr)|*.N3Chr|Plug(*.N3CPlug)|*.N3CPlug||";
...
//		}
		...
		else if(lstrcmpi(szExt, "N3CPlug") == 0)
		{
			...
			pShape->FindMinMax(); // ū��, ������ ã��..

			continue;
		}
		else continue;

		pBase->LoadFromFile(std::string(FileName)); // ���Ͽ��� �д´�..
...
void CN3ViewerDoc::OnFileExport()
{
	...
	if(dwType & OBJ_CAMERA) { szExt = "Camera"; szFilter = "ī�޶� Data(*.N3Camera)|*.N3Camera||"; }
