...
//					if(pPD)
//					{
//						if(pItem->m_curValue == "�Ӹ�ī��") pPD->m_Type = PART_HAIR;
//						else if(pItem->m_curValue == "��") pPD->m_Type = PART_FACE;
//						else if(pItem->m_curValue == "��ü") pPD->m_Type = PART_UPPER;
//						else if(pItem->m_curValue == "��ü") pPD->m_Type = PART_LOWER;
//						else if(pItem->m_curValue == "��") pPD->m_Type = PART_HAND;
//						else if(pItem->m_curValue == "��") pPD->m_Type = PART_FOOT;
...
//		m_LPCamera.AddPropItem("�Ȱ� �е�", "", PIT_EDIT, "");
		m_LPCamera.AddPropItem("�Ȱ� ��", "", PIT_COLOR, "");
//		m_LPCamera.AddPropItem("�Ȱ� ����", "", PIT_EDIT, "");
//		m_LPCamera.AddPropItem("�Ȱ� ��", "", PIT_EDIT, "");
		// Camera ��� ����
		/////////////////////////////////////
