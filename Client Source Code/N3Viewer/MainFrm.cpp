...
void CMainFrame::OnToolFixProgressiveMesh() 
{
	...
	CFile file;
	file.Open("���α׷��ú� �޽� ó�� �ȵ� ����Ʈ.txt", CFile::modeWrite | CFile::modeCreate);
	...
	for(int i = 0; pos != NULL; i++)
	{
		...
		{
			CString szWarning;
			szWarning.Format("LOD ó�� �ȵ� : %s\r\n", PM.FileName().c_str());
			file.Write(szWarning, szWarning.GetLength());
		}
	}

	MessageBox("���α׷��ú� ó���� �ȵ� ���ϸ���Ʈ�� \"���α׷��ú� �޽� ó�� �ȵ� ����Ʈ.txt\" ���Ͽ� ��ϵǾ����ϴ�.");
	file.Close();
