...
//		m_LPMtl.AddPropItem("Color Arg2", "", PIT_COMBO, strTmp);
		...
		m_LPMtl.SetDividerWidth(100); // �߰� ���Ҽ� ����
		// Material ��� ����
		/////////////////////////////////////
		...
		m_LPPlug.SetDividerWidth(100); // �߰� ���Ҽ� ����
		// Plug ��� ����
		/////////////////////////////////////

//////////////////////////////////////////////////
//	Coded (By Dino On 2002-10-11 ���� 9:53:37 )
//	FX Plug ��� ����
...
//	End Of Code (By Dino On 2002-10-11 ���� 9:53:37 )
//////////////////////////////////////////////////
...
//////////////////////////////////////////////////
//	Coded (By Dino On 2002-10-11 ���� 10:24:21 )
//	FXPlugPart
...
//	End Of Code (By Dino On 2002-10-11 ���� 10:24:21 )
//////////////////////////////////////////////////
...
//////////////////////////////////////////////////
//	Coded (By Dino On 2002-10-11 ���� 10:31:36 )
//	FXPlugPart
...
//	End Of Code (By Dino On 2002-10-11 ���� 10:31:36 )
//////////////////////////////////////////////////
...
//			if(pItem->m_propName == "Color Arg2") pMtl->dwColorArg2 = pItem->m_crColor;
	...
	else if((void*)wParam == &m_LPPlug)
	{
		...
		CN3CPlug* pPlug = (CN3CPlug*)pBase;
		pFrm->GetPaneRender()->m_eCursorMode = eCM_Nothing; // Ŀ����带 �������� �س���..
...
//////////////////////////////////////////////////
//	Coded (By Dino On 2002-10-11 ���� 10:37:54 )
//	FXPlugPart
...
//	End Of Code (By Dino On 2002-10-11 ���� 10:37:54 )
//////////////////////////////////////////////////
	else
	{
...
void CFormViewProperty::UpdateAllInfo()
{
	...
	int nNodeCur = this->GetSelectedNode(); // ���� ���õǾ� �ִ� ��� ��ȣ..
...
//////////////////////////////////////////////////
//	Coded (By Dino On 2002-10-10 ���� 4:44:49 )
//	FXPlug
...
//	End Of Code (By Dino On 2002-10-10 ���� 4:44:49 )
//////////////////////////////////////////////////
		
	CN3Joint* pJoint = pChr->Joint();
	if(pJoint)
	{
		CString szJN; szJN.Format(	"Joints - ��ü(%d ~ %d), ��ü(%d ~ %d), �Ӹ�ī��(%d ~ %d), ����(%d ~ %d)", 
	...
	this->SelectNode(nNodeCur); // ���� ���õ� ��� ��ȣ��� �����Ѵ�..
	this->UpdateWindowPos();
}
	...
	*pResult = 0;
	...
	if(hI == m_hTI_Joint) 
	{
		...
		if(pChr && pTDI->item.pszText)
		{
			...
			sscanf(pTDI->item.pszText, "Joints - ��ü(%d ~ %d), ��ü(%d ~ %d), �Ӹ�ī��(%d ~ %d), ����(%d ~ %d)",
	...
	if(pBase)
	{
		if(pTDI->item.pszText)
		{
			if(pBase->Type() & OBJ_BASE_FILEACCESS)
				((CN3BaseFileAccess*)pBase)->FileNameSet(pTDI->item.pszText); // ���� �̸��� �ٲپ� �ش�..
			else
...
void CFormViewProperty::OnTreeChrRclick(NMHDR* pNMHDR, LRESULT* pResult) 
{
	...
	HTREEITEM hI = m_TreeChr.HitTest(pt2); // ���� ��ġ���� ����
	if(NULL == hI) return;
...
void CFormViewProperty::OnTreeChrDblclk(NMHDR* pNMHDR, LRESULT* pResult) 
{
	...
	else if(pBase && (pBase->Type() & OBJ_CHARACTER_PART)) // Part�� ���.
	{
...
void CFormViewProperty::OnEditChrPartSet() 
{
	...
	FileName = dlg.GetPathName();
	pPart->Release();
	pPart->LoadFromFile(std::string(FileName)); // ���Ͽ��� �б�.
...
void CFormViewProperty::OnEditChrPlugRotationReset() 
{
	...
	if(pBase->Type() & OBJ_CHARACTER_PLUG)
	{
		...
		__Matrix44 mtxRot;
		mtxRot.Identity();
		pPlug->RotationSet(mtxRot); // ȸ���� �ʱ�ȭ..
...
void CFormViewProperty::SelectJointNode(HTREEITEM hItemParent, CN3Joint *pJoint)
{
	...
	hNext = m_TreeChr.GetNextItem(hNext, TVGN_NEXTVISIBLE))
	{
		...
		this->SelectJointNode(hNext, pJoint); // ��� ȣ��..
	}
}
...
void CFormViewProperty::OnUpdateEditSetVisible(CCmdUI* pCmdUI) 
{
	...
	if(bVisible) pCmdUI->SetText("�����\t(&V)");
	else pCmdUI->SetText("���̱�\t(&V)");
}
