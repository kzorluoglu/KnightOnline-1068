...
void CN3FXSPart::Release()
{
	...
	m_WorldMtx.Identity(); // World Matrix.. Shape Loading �� �̸� ����ؾ� ����..		
...
// timeGetTime ���� ���� ���� ������ Texture Animation �� ��Ʈ�� �Ѵ�..
void CN3FXSPart::Tick(const __Matrix44& mtxParent) 
{
	...
	if(s_CameraData.IsOutOfFrustum(this->m_WorldMtx.Pos(), fRadius * 3.0f)) // ī�޶� ���ü �ٱ��̸� ��������..
	{
		m_bOutOfCameraRange = TRUE;
		return;
	}
...
bool CN3FXShape::Load(HANDLE hFile)
{
	...
	DWORD dwTmp;		
	ReadFile(hFile, &dwTmp, 4, &dwRWC, NULL); // �Ҽ�
	ReadFile(hFile, &dwTmp, 4, &dwRWC, NULL); // �Ӽ� 0
	ReadFile(hFile, &dwTmp, 4, &dwRWC, NULL); // �Ӽ� 1
	ReadFile(hFile, &dwTmp, 4, &dwRWC, NULL); // �Ӽ� 2
	ReadFile(hFile, &dwTmp, 4, &dwRWC, NULL); // �Ӽ� 3
...
bool CN3FXShape::Save(HANDLE hFile)
{
	...
	WriteFile(hFile, &m_iAttr0, 4, &dwRWC, NULL); // �Ӽ� 0
	WriteFile(hFile, &m_iAttr1, 4, &dwRWC, NULL); // �Ӽ� 1
	WriteFile(hFile, &m_iAttr2, 4, &dwRWC, NULL); // �Ӽ� 2
	WriteFile(hFile, &m_iAttr3, 4, &dwRWC, NULL); // �Ӽ� 3
	*/
	return true;
}
