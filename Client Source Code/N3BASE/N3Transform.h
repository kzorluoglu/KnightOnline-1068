...
public:
	__Vector3		m_vPos;
	__Matrix44		m_Matrix; // ��ȯ ���

	CN3AnimKey		m_KeyPos; // ���ϸ��̼� Ű
	CN3AnimKey		m_KeyRot;
	CN3AnimKey		m_KeyScale;

	float			m_fFrmWhole; // ��ü �����Ӽ�
	float			m_fFrmCur; // ���� ������

public:
	virtual void	Tick(float fFrm = FRAME_SELFPLAY);
	virtual bool	TickAnimationKey(float fFrm); // Animation Key Tick... Animation Key �� �־� �����̸� true, �ƴϸ� false �� return;
