...
CN3Camera::CN3Camera()
{
	...
	m_Data.fFOV = D3DXToRadian(55.0f); // �⺻�� 55 ��
	m_Data.fNP = 0.7f;
	m_Data.fFP = 512.0f;
...
#ifndef _N3INDOOR
	if(fDist < 0.3f) return; // �ʹ� ������ �������� �ʴ´�..
	else if(fDist > m_Data.fFP * 2.0f) return; // �ʹ� �ָ� �������� �ʴ´�.
#endif
...
void CN3Camera::Rotate(float fRadianX, float fRadianY)
{
	...
	__Vector3 v1 = m_vAt - m_vPos, v2; // Rotation �� LookAt Position ó��, Scale �� UpVector ó�� ����..
	v1 *= mtx;
	m_vScale *= mtx;
...
//	s_lpD3DDev->SetRenderState( D3DRS_FOGTABLEMODE,   D3DFOG_EXP2);
	...
	// Range Fog : ���� - �Ÿ�������� fog�� ����ȴ�. ���� - poligon������ ���� fog���� ����ȴ�.(ū �������� ������� ����� fog�� �� �� �ִ�.)
	// range fog = FALSE�� �������� depth���� ������� fog�� ���Ǿ� ����ȴ�.

	// vertex fog �� pixel fog(table fog)�� ���� - Dino��..
	// vertex fog : vertex�� depth���� ������� vertex������ �������� ���Ǵ� �� ����.
	//				���� ī�޶� �����ٺ��� vertex������ �߽����� fog�� ���ϴ°��� �����ȴ�.
	// pixel fog : pixel�� depth���� ������� fog�� ����ϴ°� ����.
