...
public:
	...
	__Matrix44	m_WorldMtx;				// World Matrix.. Shape Loading �� �̸� ����ؾ� ����..		
...
public:
	...
	__Vector3 Min() { if(m_FXPMInst.GetMesh()) return m_FXPMInst.GetMesh()->Min() * m_WorldMtx; else return __Vector3(0,0,0); } // ���� ���� �ּҰ�
	__Vector3 Max() { if(m_FXPMInst.GetMesh()) return m_FXPMInst.GetMesh()->Max() * m_WorldMtx; else return __Vector3(0,0,0); } // ���� ���� �ִ밪
