...
CN3IMesh::CN3IMesh()
{
	...
	m_pwVtxIndices = NULL; // �� �ε��� ����Ʈ. 
	m_pwUVsIndices = NULL; // �ؽ�ó ��ǥ �ε��� ����Ʈ.
...
CN3IMesh::~CN3IMesh()
{
	...
	delete [] m_pwVtxIndices; m_pwVtxIndices = NULL; // �� �ε��� ����Ʈ. 
	delete [] m_pwUVsIndices; m_pwUVsIndices = NULL; // �ؽ�ó ��ǥ �ε��� ����Ʈ.
...
bool CN3IMesh::Create(int nFC, int nVC, int nUVC)
{
	...
	if(nUVC > 0)
	{
		m_nUVC = nUVC; m_pfUVs = new float[nUVC*2]; memset(m_pfUVs, 0, 8 * nUVC); // ����� 8 �� ������ float 2���� �׷���..
...
void CN3IMesh::RenderSelected()
{
	...
	for(int i = 0; i < m_nFC; i++)
	{
		...
		vFace[2] = pVs[i*3+2];
		vFace[3] = vFace[0];
		CN3Base::RenderLines(vFace, 3, 0xff00ff00); // ������� ������..
	}
}
