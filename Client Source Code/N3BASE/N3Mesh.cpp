...
bool CN3Mesh::Load(HANDLE hFile)
{
	...
	ReadFile(hFile, &m_nVC, 4, &dwRWC, NULL); // ������ �б�..
	if(m_nVC > 0)
	{
		this->Create(m_nVC, 0); // Vertex Buffer ���� �� ������ ä���
		ReadFile(hFile, m_pVertices, m_nVC * sizeof(__VertexT1), &dwRWC, NULL);
		this->FindMinMax(); // �ִ�, �ּҰ��� ã�´�.
	}
	
	ReadFile(hFile, &m_nIC, 4, &dwRWC, NULL); // �ε��� ���� �б�..
	if(m_nIC > 0)
	{
		this->Create(0, m_nIC); // �ε��� ���� ���� �� ������ ä���
...
bool CN3Mesh::Save(HANDLE hFile)
{
	...
	WriteFile(hFile, &m_nIC, 4, &dwRWC, NULL); // �ε��� ���� �б�..
	if(m_nIC > 0)
	{
...
void CN3Mesh::Create(int nVC, int nIC)
{
	if(nVC > 0) // ���� ������...
	{
		...
		m_pVertices = new __VertexT1[nVC]; memset(m_pVertices, 0, nVC * sizeof(__VertexT1)); // Vertex Buffer ����
		m_nVC = nVC;
	}
	...
	if(nIC > 0) // Mesh �ε��� �����ϰ�, �ε����� ������..
	{
		...
		m_psnIndices = new WORD[nIC]; memset(m_psnIndices, 0, nIC * 2); // Index Buffer ����
		m_nIC = nIC;
	}
}
