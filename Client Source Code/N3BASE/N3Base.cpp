...
//////////////////////////////////////////////////////////////////////
LPDIRECT3DDEVICE9 CN3Base::s_lpD3DDev	= NULL;			// ���� ������.. �ڴ�� �����ϸ� �ȵȴ�..
DWORD CN3Base::s_dwTextureCaps			= 0;			// Texture ȣȯ��..
float CN3Base::s_fFrmPerSec				= 30.0f;		// Frame Per Second
float CN3Base::s_fSecPerFrm				= 1.0f/30.0f;	// Second per Frame
HWND CN3Base::s_hWndBase				= NULL;			// Init �Ҷ� �� Window Handle
HWND CN3Base::s_hWndPresent				= NULL;			// �ֱٿ� Present �� Window Handle

D3DPRESENT_PARAMETERS CN3Base::s_DevParam;	// Device ���� Present Parameter
D3DCAPS9 CN3Base::s_DevCaps;				// Device ȣȯ��...
...
__Options CN3Base::s_Options;	// ���� �ɼǵ�...
#ifdef _DEBUG
__RenderInfo CN3Base::s_RenderInfo;			// Rendering Information
#endif

#ifdef _N3GAME // ������ �ƴ� �������� �ʿ����...
CN3SndMgr CN3Base::s_SndMgr;	//���� �޴���.
#endif
#ifdef _N3UIE	// ui �������϶��� �ʿ��ϴ�.
CN3SndMgr CN3Base::s_SndMgr;	//���� �޴���.
#endif
...
CN3Mng<CN3VMesh>		CN3Base::s_MngVMesh; // �ܼ��� �����︸ ���� �ִ� �޽� - �ַ� �浹 üũ�� ����..
...
CN3Mng<CN3FXPMesh>		CN3Base::s_MngFXPMesh; // FX���� ���� PMesh - ������ �Ϲ� PMesh�� ������ ���� �ٸ���.
CN3Mng<CN3FXShape>		CN3Base::s_MngFXShape; // FX���� ���� Shape - ������ �Ϲ� shape�� ������ ���� �ٸ���.	

CN3AlphaPrimitiveManager	CN3Base::s_AlphaMgr;  // Alpha blend �� ��������� ����.. �߰��ߴٰ�.. ī�޶� �Ÿ��� ���߾� �����ϰ� �Ѳ����� �׸���..
...
CN3Base::CN3Base()
{
	m_dwType = OBJ_BASE; // "MESH", "CAMERA", "SCENE", "???" .... ����...
	m_szName = "";
}
