...
{
	if (m_pPMesh && m_pPMesh->FileName() == szFN) return true;	// ���� �̸��� ������ ���� ������ �ʰ� ��������
	this->Release();
...
{
	if (m_pCollapseUpTo >= m_pPMesh->m_pCollapses + m_pPMesh->m_iNumCollapses) return false; // �̷��� �ϸ� ������ �ϳ��� ���� ������ �ȴ�..
	// ������ �̷��� �ٽ� �ϴ� ������ �Ʒ� �ڵ�� �ϸ� ������ �������� ���� �׷����� �ʴ´�.
	// �̷��� �ص� ������ �� �ֵ��� ����ڵ带 �־���. m_pPMesh->m_pCollapses �� �Ҵ��Ҷ� 1�� �� �Ҵ��ϰ� ������ �����͸� �ʱⰪ���� �־���.
//	if (m_pCollapseUpTo >= m_pPMesh->m_pCollapses + m_pPMesh->m_iNumCollapses - 1) return false; // �̰� �����̴�..
...
void CN3PMeshInstance::RenderTwoUV()
{
	...
	{
		m_pPMesh->GenerateSecondUV(); // �ι�° UV �� ���� ���� �����..
	}
