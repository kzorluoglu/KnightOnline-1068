...
void CN3FXPlugPart::SetFXB(const std::string& strFN)
{
	...
	m_vOffsetPos = m_pFXB->m_vPos;	//�ϴ� FXB�� �����Ǿ� �ִ� vPos�� vDir���� �����ͼ� ����.
...
bool CN3FXPlug::Load(HANDLE hFile)
{
	...
	DWORD dwNum;
	int i, nCount;
	ReadFile(hFile, &nCount, sizeof(nCount), &dwNum, NULL);		// Part�� ����
...
bool CN3FXPlug::Save(HANDLE hFile)
{
	...
	RemoveFXPParts_HaveNoBundle();	// ���� ���� ��Ʈ�� �����

	DWORD dwNum;
	int i, nCount = m_FXPParts.size();
	WriteFile(hFile, &nCount, sizeof(nCount), &dwNum, NULL);		// Part�� ����
	for(i=0; i<nCount; ++i)	m_FXPParts[i]->Save(hFile);

	return true;
}

void CN3FXPlug::RemoveFXPParts_HaveNoBundle()	// ���� ���� Part�� �����ϱ�
{
	int i, nCount = m_FXPParts.size();
	for(i=0; i<nCount; ++i)
	{
