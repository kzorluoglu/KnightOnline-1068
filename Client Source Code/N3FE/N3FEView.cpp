...
void CN3FEView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	...
	float fT, fU, fV;
	::_IntersectTriangle(vPos, vDir, vPlane[0], vPlane[1], vPlane[2], fT, fU, fV, &m_vTarget); // �ٴڰ� �浹�� �����Ѵ�..
	::_IntersectTriangle(vPos, vDir, vPlane[0], vPlane[2], vPlane[3], fT, fU, fV, &m_vTarget); // �ٴڰ� �浹�� �����Ѵ�..
