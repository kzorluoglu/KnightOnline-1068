...
//	m_EffectMgr.PathSet(szPath); // Path �ʱ�ȭ..
...
BOOL CN3FEDoc::OnOpenDocument(LPCTSTR lpszPathName) 
{
	...
	char szDrive[_MAX_DRIVE], szDir[_MAX_DIR], szFName[_MAX_FNAME], szExt[_MAX_EXT]; // ���� �̸��� �и��ϰ�..
	_splitpath(lpszPathName, szDrive, szDir, szFName, szExt);

	char szTmp[256];
	GetPrivateProfileString("Effect Manager", "Name", "NoName", szFName, _MAX_PATH, lpszPathName); // Ini ���Ͽ� �̸� ����..
	GetPrivateProfileString("Effect Manager", "BundelCount", "0", szTmp, 256, lpszPathName); // Ini ���Ͽ� ��ġ ���� ����..
	int nBC = atoi(szTmp);
	GetPrivateProfileString("Effect Manager", "PartCount", "0", szTmp, 256, lpszPathName); // Ini ���Ͽ� ��Ʈ ���� ����..
	int nPC = atoi(szTmp);
...
BOOL CN3FEDoc::OnSaveDocument(LPCTSTR lpszPathName) 
{
	...
	m_EffectMgr.SaveToFile(szGameFN); // Binary ����..
	// Binary ����..
	///////////////////////////////////////////////////
...
//	file.Write("PartCount=\r\n", 12);
	...
	CString szTmp;
	WritePrivateProfileString("Effect Manager", "Name", szFName, lpszPathName); // Ini ���Ͽ� �̸� ����..
	szTmp.Format("%d", m_EffectMgr.BundleCount());
	WritePrivateProfileString("Effect Manager", "BundelCount", szTmp, lpszPathName); // Ini ���Ͽ� ��ġ ���� ����..
	szTmp.Format("%d", m_EffectMgr.PartCount());
	WritePrivateProfileString("Effect Manager", "PartCount", szTmp, lpszPathName); // Ini ���Ͽ� ��Ʈ ���� ����..
