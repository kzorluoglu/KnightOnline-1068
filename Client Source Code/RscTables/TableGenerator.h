...
protected:
	...
	std::vector<CTableData>		m_Datas; // �⺻�� �Ǵ� ������ ���̺�
	std::vector<CTableDataExt>	m_DataExts; // ������ ������ ���̺�

private:
	int ParseLine(const char* szLine, int& iOffset, int& iVal, DWORD& dwVal, double& dfVal, std::string& szText); // �����ϸ� 0, �߰��ؾ��ϰ� ���̸� -1 �߰��� �ʿ� ���� ���̸�.. -2 ����
