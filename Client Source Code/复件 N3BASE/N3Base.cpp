...
CN3Mng<CN3CPart>	CN3Base::s_MngCPart; // Character �� ���� Part Manager
CN3Mng<CN3AnimControl>	CN3Base::s_MngAniCtrl; // Animation Manager

LPDIRECT3DDEVICE8 CN3Base::s_lpD3DDev = NULL; // ���� ������.. �ڴ�� �����ϸ� �ȵȴ�..
D3DPRESENT_PARAMETERS CN3Base::s_DevParam; // Device ���� Present Parameter
D3DCAPS8 CN3Base::s_DevCaps; // Device ȣȯ��...
...
HWND CN3Base::s_hWndPresent; // �ֱٿ� Present �� Window Handle
HWND CN3Base::s_hWndBase; // Init �Ҷ� �� Window Handle


LARGE_INTEGER CN3Base::s_TimePrev; // �ð�..
...
void CN3Base::FileNameSet(const char* szFileName)
{
	...
	char szFNTmp[512];
	lstrcpy(szFNTmp, szFileName); // �ӽ÷� �����ϰ�..
	CharLower(szFNTmp); // ��� �ҹ��ڷ� �����..
