...
__Vector3 __tempV; // Vector, Matrix ���� ���� �ӽ� ����
__Matrix44 __tempM; // Vector, Matrix ���� ���� �ӽ� ����
...
void CN3Eng::Release()
{
	...
	if(s_lpD3DDev)
	{
		...
		{
			MessageBox(s_hWndDevice, "���� ����� 0 �̻��Դϴ�.", "Device Release ���", MB_OK);
		}
	}
}
...
{
	memset(&s_ResrcInfo, 0, sizeof(CN3Base::__ResrcInfo)); // Rendering Information �ʱ�ȭ..

	if(NULL == s_hWndDevice) return false;

	s_hWndBase = hWnd;

	int nAMC = m_lpD3D->GetAdapterModeCount(0); // ���÷��� ��� ī��Ʈ
	...
	{
		m_lpD3D->EnumAdapterModes(0, i, &m_DeviceInfo.pModes[i]); // ���÷��� ��� ��������..
	}
...
//			m_DeviceInfo.pModes[i].Height == dwHeight && 
	...
	if(rval != D3D_OK)
	{
		...
		if(rval != D3D_OK)
		{
			...
			MessageBox(hWnd, szDebug, "Direct3D Device ���� ����", MB_OK);
			this->Release();
			return false;
		}
#if _DEBUG
