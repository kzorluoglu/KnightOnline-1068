...
//		m_pIndices = new WORD[m_iMaxNumIndices];
	...
	ReadFile(hFile, &bHaveWeaponTrack, 4, &dwNum, NULL); // ������ �ִ���...
	if(bHaveWeaponTrack)
	{
		if(NULL == m_pWeaponTrack) m_pWeaponTrack = new __WeaponTrack;
		ReadFile(hFile, m_pWeaponTrack, sizeof(__WeaponTrack), &dwNum, NULL); // ���� ������..
	}
...
bool CN3PMesh::Save(HANDLE hFile)
{
	...
	WriteFile(hFile, &bHaveWeaponTrack, 4, &dwNum, NULL); // ������ �ִ���...
	if(bHaveWeaponTrack)
	{
		WriteFile(hFile, m_pWeaponTrack, sizeof(__WeaponTrack), &dwNum, NULL); // ���� ������..
	}
