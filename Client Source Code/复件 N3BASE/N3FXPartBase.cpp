...
const DWORD RF_NOTUSEFOG		= 0x2;		// �Ȱ� ����
const DWORD RF_DOUBLESIDED		= 0x4;		// ��� - D3DCULL_NONE
const DWORD RF_BOARD_Y			= 0x8;		// Y ������ �ؼ�.. ī�޶� ����.
const DWORD RF_POINTSAMPLING	= 0x10;		// MipMap ����.. PointSampling ���� �Ѵ�..
const DWORD RF_WINDY			= 0x20;		// �ٶ��� ������.. �ٶ��� ���� CN3Base::s_vWindFactor �� ���� �Ѵ�..
const DWORD RF_NOTUSELIGHT		= 0x40;		// Light Off
const DWORD RF_DIFFUSEALPHA		= 0x80;		// Diffuse ���� ���� �����ϰ� Alpha blending
const DWORD RF_NOTZWRITE		= 0x100;	// ZBuffer �� �Ⱦ���.
const DWORD RF_UV_CLAMP			= 0x200;	// texture UV������ Clamp�� �Ѵ�..default�� wrap�̴�..
const DWORD RF_NOTZBUFFER		= 0x400;	// ZBuffer ����.
*/
}
