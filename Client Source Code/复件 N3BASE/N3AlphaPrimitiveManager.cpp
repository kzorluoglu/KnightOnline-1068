...
void CN3AlphaPrimitiveManager::Render()
{
	...
	qsort(pBuffs, m_nToDrawCount, 4, SortByCameraDistance); // ���ۿ� ���� ������Ƽ���� �����ϰ�..
	...
	__RenderState RS_old;		// ���� render state (���߿� �ǵ������� ����)
	__RenderState RS_current;	// ���� render state (���� � �����ΰ� �Ǵ��ϱ� ����)
	...
	for(i = 0; i < m_nToDrawCount; i++)
	{
		...
		if(pBuffs[i]->pwIndices && pBuffs[i]->nPrimitiveCount > 0) // Index �� ������..
		{
			if (pBuffs[i]->bUseVB)
			{
...
int CN3AlphaPrimitiveManager::SortByCameraDistance(const void *pArg1, const void *pArg2)
{
	...
	if(pObj1->fCameraDistance > pObj2->fCameraDistance) return -1; // �Ÿ��� �հͺ��� ����..
