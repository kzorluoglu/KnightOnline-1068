...
bool CN3Scene::Save(HANDLE hFile)
{
	...
	WriteFile(hFile, &m_nChrCount, 4, &dwRWC, NULL); // ĳ����
...
//					s_lpD3DDev->SetRenderState( D3DRS_AMBIENT, dwAmbient ); // Ambient Light ����..
...
void CN3Scene::CheckOverlappedAndReport()
{
	...
	for(i = 0; i < nBC; i++)
	{
		for(j = i+1; j < nBC; j++)
		{
			...
			{
				char szErr[512];
				wsprintf(szErr, "%s : �̸��� ���� ������Ʈ�� �ֽ��ϴ�.", pBases[i]->Name());
				MessageBox(s_hWndBase, szErr, "Scene �ߺ� �̸� ����", MB_OK);
			}
		}
	}
}
