...
//};
	...
	m_LPProperty.AddPropItem("�̸�", "", PIT_EDIT, "");
	m_LPProperty.AddPropItem("����", "", PIT_COMBO, "�ϴû�|�Ȱ���|����|�޸��|���� ��|���� Glow ��|���� Flare ��|������1�� ��|������2�� ��|�����ؽ�ó �ٲٱ�|����Ʈ0|����Ʈ1|����Ʈ2");
	m_LPProperty.AddPropItem("�μ�1", "", PIT_EDIT, "");
	m_LPProperty.AddPropItem("��1", "", PIT_COLOR, "");
	m_LPProperty.AddPropItem("�μ�2", "", PIT_EDIT, "");
	m_LPProperty.AddPropItem("��2", "", PIT_COLOR, "");
	m_LPProperty.AddPropItem("�ð�", "", PIT_EDIT, "0��0��");
	m_LPProperty.AddPropItem("�����ð�", "", PIT_EDIT, "0��");
...
BOOL CFormViewProperty::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult) 
{
	if((void*)wParam == &m_LPProperty)
	{
		...
		if(pItem->m_propName == "�̸�") pSDC->szName = pItem->m_curValue;
		else if(pItem->m_propName == "�ð�")
		{
			int iHour = 0, iMin = 0;
			sscanf(pItem->m_curValue, "%d��%d��", &iHour, &iMin);
			pSDC->dwWhen = CONVERT_SEC(iHour,iMin,0);
		}
		else if(pItem->m_propName == "����")	pSDC->eSkyDayChange = (eSKY_DAYCHANGE)(pItem->m_crColor);
		else if(pItem->m_propName == "�μ�1")	pSDC->dwParam1 = atoi(pItem->m_curValue);
		else if(pItem->m_propName == "��1")		pSDC->dwParam1 = ::_RGB_To_D3DCOLOR(pItem->m_crColor, (DWORD)255);
		else if(pItem->m_propName == "�μ�2")	pSDC->dwParam2 = atoi(pItem->m_curValue);
		else if(pItem->m_propName == "��2")		pSDC->dwParam2 = ::_RGB_To_D3DCOLOR(pItem->m_crColor, (DWORD)255);
		else if(pItem->m_propName == "�����ð�") pSDC->fHowLong = (float)(atof(pItem->m_curValue));
...
void CFormViewProperty::UpdateInfo()
{
	...
	CPropertyItem* pItem0 = m_LPProperty.GetPropItem("�̸�");
	CPropertyItem* pItem1 = m_LPProperty.GetPropItem("�ð�");
	CPropertyItem* pItem2 = m_LPProperty.GetPropItem("����");
	
	CPropertyItem* pItem3 = m_LPProperty.GetPropItem("�μ�1");
	CPropertyItem* pItem4 = m_LPProperty.GetPropItem("��1");
	CPropertyItem* pItem5 = m_LPProperty.GetPropItem("�μ�2");
	CPropertyItem* pItem6 = m_LPProperty.GetPropItem("��2");
	
	CPropertyItem* pItem7 = m_LPProperty.GetPropItem("�����ð�");
	...
	if(NULL == pSDC)
	{
		...
		if(pItem1) pItem1->m_curValue = "0��0��";
	...
	else
	{
		...
		if(pItem1)
		{
			...
			pItem1->m_curValue.Format("%d��%d��", iHour, iMin);
		}
...
void CFormViewProperty::OnDblclkListCloudTextures() 
{
	...
	CFileDialog dlg(TRUE, "DXT", NULL, dwFlags, "Texture �� ���� �ִ� �׸� ����(*.DXT; *.BMP; *.TGA)|*.DXT; *.BMP; *.TGA||", NULL);
